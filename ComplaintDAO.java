...
public class ComplaintDAO {
	...
	public String generateCompId() throws ClassNotFoundException, SQLException {
		...
		connection = ConnectionHelper.getConnection();
	    String sql ="select  case when max(ComplaintId) is null Then 'C001' else max(ComplaintId) end complaintId from Complaint";
	    pst=connection.prepareStatement(sql);
	    ResultSet rs = pst.executeQuery();
	    rs.next();
	    String cmpId = rs.getString("ComplaintId");
